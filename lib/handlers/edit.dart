...
add_component(scene, String path, String name, int type) async {
  ...
  List scene_data = await read_data(sub_dir_scene);
  scene_file.openWrite().write(path + r"\flutter_project\lib\components\" + name);


  if(await scene_file.exists()){
    switch(type){
      case 0:
        component_data = await read_data(Directory.current.path + r'\flutter_project\lib\game_engine\components\empty_component.dart');
        break;
      case 1:
        component_data = await read_data(Directory.current.path + r'\flutter_project\lib\game_engine\components\box_collider.dart');
        break;
      case 2:
        component_data = await read_data(Directory.current.path + r'\flutter_project\lib\game_engine\components\camera.dart');
        break;
      case 3:
        component_data = await read_data(Directory.current.path + r'\flutter_project\lib\game_engine\components\animation.dart');
        break;
      case 4:
        component_data = await read_data(Directory.current.path + r'\flutter_project\lib\game_engine\components\sound.dart');
        break;
      case 5:
        component_data = await read_data(Directory.current.path + r'\flutter_project\lib\game_engine\components\gif_background.dart');
        break;
      case 6:
        component_data = await read_data(Directory.current.path + r'\flutter_project\lib\game_engine\components\gif_effect.dart');
        break;
      case 7:
        component_data = await read_data(Directory.current.path + r'\flutter_project\lib\game_engine\components\text.dart');
        break;
      default:
        break;
    }
